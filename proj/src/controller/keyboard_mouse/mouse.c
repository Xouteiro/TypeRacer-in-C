...
uint8_t current_byte;         // o byte lido mais recentemente
...
void (mouse_sync_info)(){
  ...
  if (delta_x < 0 || delta_x > mode_info.XResolution || delta_y < 0 || delta_y > mode_info.YResolution) return; //se estiver fora do ecrã
